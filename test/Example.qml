...
import "../qml/controls" // Aqui se encuentra LeftMenuBtn.qml
...
Window {
    ...
    //     source: "../qml/controls/LeftMenuBtn.qml"  // Ruta al archivo QML del botón.
    ...
    QtObject{
        ...
        function createButton(name, address, mail, city, zip_code, phone) {
            // if (leftMenuBtnLoader.status == Loader.Ready) {
            ...
            if (leftMenuBtnComponent.status === 1) {
                ...
                // Configurar señal clicked y añadir el botón a la lista
